  ...
  return (
    <React.Fragment>
        ...
        {searchBool && filterBool && searchAndFilteredCountries.map((country , index) => ( 
          <>
          <div key={index} className=' bg-white rounded-md shadow-md max-w-96 lg:hover:drop-shadow-2xl lg:hover:-translate-y-4 lg:duration-500 lg:transition cursor-pointer'
